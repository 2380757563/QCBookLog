<template>
  <div class="reading-settings-container">
    ...
    <div class="content">
      ...
      <div class="cards-col">
      <!-- 热力图设置 -->
      <CollapsibleSection icon="🔥" title="热力图滚动设置" desc="自定义热力图的滚轮和触摸划动灵敏度">
        <!-- 预设选项 -->
      ...
      <div class="cards-col">
      <CollapsibleSection icon="📑" title="年份书签" desc="配置热力图顶部书签标签的显示范围">
      ...
      <!-- 其他阅读设置 -->
      <CollapsibleSection icon="⚙️" title="其他设置">
        <div class="setting-item">
...
.content {
  flex: 1;
  padding: 1rem;
  /* 卡片间距由 CollapsibleSection 组件的 margin-bottom 统一提供 */
  display: flex;
  flex-direction: column;
}
